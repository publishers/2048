...
public class ActionFieldUpTest {
  ...
  public ActionFieldUpTest(Cell[][] actualCellsUp, Cell[][] expectedCellsUp) {
  ...
  public static List<Object[]> data() {
    ...
    data.add(new Object[]{
            ...
            new Cell[][]{
                    {instance(8, 0, 0), instance(10, 0, 1), instance(4, 0, 2)},
                    {instance(0, 1, 0), instance(0, 1, 1), instance(0, 1, 2)},
    ...
    data.add(new Object[]{
            ...
            new Cell[][]{
                    {instance(4, 0, 0), instance(4, 0, 1), instance(4, 0, 2)},
    ...
    data.add(new Object[]{
            ...
            new Cell[][]{
                    {instance(0, 0, 0), instance(2, 0, 1), instance(0, 0, 2)},
                    {instance(0, 1, 0), instance(0, 1, 1), instance(0, 1, 2)},
                    {instance(0, 2, 0), instance(0, 2, 1), instance(0, 2, 2)}
            }
    });
